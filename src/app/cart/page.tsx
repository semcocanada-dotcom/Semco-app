    ...
    return (
      <div className="min-h-screen bg-bg flex flex-col">
        <div className="bg-surface border-b border-separator px-4 pt-14 pb-4">
          <h1 className="text-[22px] font-bold text-text1">Cart</h1>
        </div>
        <div className="flex-1 flex flex-col items-center justify-center px-8 text-center py-20">
          <div className="w-16 h-16 bg-bg rounded-full flex items-center justify-center mb-4 border border-separator">
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
              <path d="M4 4H6L8.5 16.5H22L24 8H8" stroke="#6E6E73" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="11" cy="21" r="1.5" fill="#6E6E73" />
              <circle cx="20" cy="21" r="1.5" fill="#6E6E73" />
            </svg>
          </div>
          <p className="text-[18px] font-semibold text-text1">Your cart is empty</p>
          <p className="text-[14px] text-text2 mt-1 mb-6">Add items to get started</p>
          <Link
            href="/search"
            className="bg-brand text-white text-[15px] font-semibold px-6 py-3 rounded-full active:scale-95 transition-transform"
          >
            Browse Products
          </Link>
        </div>
    ...
    <div className="min-h-screen bg-bg">
      ...
      <div className="bg-surface border-b border-separator px-4 pt-14 pb-4">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={clearCart}
            className="text-[14px] text-text2 font-medium"
          >
            Clear
          </button>
        </div>
        ...
        <div className="mx-4 pb-2">
          <button
            ...
            className={`w-full py-4 rounded-2xl text-[17px] font-semibold text-white transition-all duration-200 active:scale-[0.98] shadow-card-lg ${
              placing ? "bg-brand/70" : "bg-brand hover:bg-brand-dark"
            }`}
          >
            {placing ? (
