...
const styles = StyleSheet.create({
  ...
  btnText: { color: Colors.navy, fontSize: Typography.size.xl, fontFamily: Fonts.medium, fontWeight: Typography.weight.medium },
  valueBox: {
    minWidth: 72,
    height: TAP_TARGET_MIN,
    borderRadius: Radius.md,
  ...
  value: { color: Colors.semcoOrange, fontSize: Typography.size.lg, fontFamily: Fonts.bold, fontWeight: Typography.weight.bold },
  hint: { color: Colors.textDisabled, fontSize: Typography.size.sm, fontFamily: Fonts.regular },
});
