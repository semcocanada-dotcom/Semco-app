      ...
      <tbody>
        ${mileageLogs.map(m => `
          <tr>
            ...
            <td>${m.description ?? '—'}${m.is_round_trip ? ' (round trip)' : ''}</td>
...
<div class="info-grid">
  <div class="info-card">
    ...
    ${child.health_card_number ? `<p>Health Card: ${child.health_card_number}</p>` : ''}
  </div>
  <div class="info-card">
    <h3>Funding Year</h3>
...
<div class="footer">
  <p>This report was generated by Semco — Saskatchewan IAF Grant Tracker</p>
  <p>Parent/Guardian: ${parentName} · Generated ${format(new Date(), 'MMMM d, yyyy \'at\' h:mm a')}</p>
